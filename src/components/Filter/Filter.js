...
const Filter = ({buttonText, onApply, options, clearAll, filterName, currentFilters}) => {
    ...
    return (
        <div className="relative" ref={filterRef}>
            <div
                className="flex justify-between py-2 px-4 rounded-lg border border-neutral-200 bg-white shadow-xs text-neutral-900 text-center font-inter text-base leading-6 cursor-pointer"
